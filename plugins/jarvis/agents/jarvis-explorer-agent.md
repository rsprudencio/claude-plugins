...
tools: Read, Grep, Glob, mcp__plugin_jarvis_core__jarvis_read_vault_file, mcp__plugin_jarvis_core__jarvis_list_vault_dir, mcp__plugin_jarvis_core__jarvis_file_exists, mcp__plugin_jarvis_core__jarvis_query_history, mcp__plugin_jarvis_core__jarvis_file_history, mcp__plugin_jarvis_core__jarvis_retrieve, mcp__plugin_jarvis_core__jarvis_resolve_path, mcp__plugin_jarvis_core__jarvis_list_paths
model: haiku
